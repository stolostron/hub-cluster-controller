...
func ApplyHubHelmSub(ctx context.Context, dynamicClient dynamic.Interface, managedClusterName string) error {
	...
	acmHubSubscriptionBytes := getACMHubSubscription("default", defaultInstallNamespace, "2.5.0")
